...
// void asm_pointwise_montgomery_55(int32_t c[N], const int32_t a[N], const int32_t b[N]);
.global asm_pointwise_montgomery_55
.type asm_pointwise_montgomery_55,%function
.align 2
asm_pointwise_montgomery_55:
    push.w {r4-r11, r14}
    c_ptr .req r0
    a_ptr .req r1
    b_ptr .req r2
...
asm_pointwise_montgomery_5:
    ...
    1:
        ldr.w pa1, [a_ptr, #4] //offset + 4를 의미
        ldr pa0, [a_ptr], #8	//pa0 ldr 이후 a_ptr+=12
        ldr.w pb1, [b_ptr, #4]
        ldr pb0, [b_ptr], #8
